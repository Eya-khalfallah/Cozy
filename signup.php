...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['nom']) && isset($_POST['email']) && isset($_POST['phone']) && isset($_POST['mot_de_passe'])) {
    // Retrieve form data
    $nom = $_POST['nom'];
    $email = $_POST['email'];
    $phone = $_POST['phone'];
    ...
    $stmt = $conn->prepare("INSERT INTO utilisateur (nom, email, phone, mot_de_passe) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssss", $nom, $email, $phone, $mot_de_passe);
